...
In an empirical evaluation on a recent snapshot of the Lightning Network we show that the imbalance distribution of the network has a Kolmogorov Smirnoff distance of 0.74 to the imbalance distribution after the heuristic is applied.
...
We conducted 4 different strategies for selecting rebalancing cycles which lead to similar results indicating that a collaborative approach within the friend of the friend network might be preferable from a practical point of view. 
