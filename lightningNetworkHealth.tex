...
The decision to use source base routing together with the unknown channel balances of the network results in a challenge for finding a path of payment channels that all have enough balance to be able to route an attempted payment.
