...
\end{figure}
From figure \ref{fig:initial_funds} we can see the result of our random process of allocating funds to the nodes.
...
The diameter of the strongly connected component had a value of 10 and the cumulative distance distribution of shortest paths between all pairs can be seen in figure \ref{fig:cumulative_distance}
\begin{figure}
 \centering
...
\end{figure}
Figure \ref{fig:initial_ginis} depicts the initial distribution of Ginicoefficients for each node of the examined network.
