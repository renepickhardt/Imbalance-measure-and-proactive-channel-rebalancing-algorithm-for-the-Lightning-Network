...
%\title{Proactive rebalancing of payment channels in the Lightning Network}
%\title{Implications of payment channel imbalance for median possible payment amounts and payment success rates on the Lightning Network}
%\title{Improving path finding in the Lightning Network by proactive rebalancing of payment channels with an heuristic}
...
\Cref{fig:initial_ginis} depicts the initial distribution of Gini coefficients for each node of the examined network.
...
\Cref{fig:fees} shows that the overall fees are normally distributed around $0$.
