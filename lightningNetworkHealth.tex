...
We then introduce the notation and definition of the imbalance score in section \ref{sec:formalization}.
After we show a small example of our definitions in section \ref{sec:example} we formulate the optimization problem to reduce the imbalance and propose a greedy, agent based and collaborative algorithm in \ref{sec:Algorithm} to address the optimization problem.
